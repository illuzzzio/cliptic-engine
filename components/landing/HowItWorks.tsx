...
const steps = [
  { icon: Upload,   color: C.red,    step: "01", title: "Upload Your Video",     desc: "Drop any long-form video — interviews, podcasts, lectures, streams. We support MP4, MOV, AVI, and more up to 4 hours." },
  { icon: Cpu,      color: C.yellow, step: "02", title: "AI Analyzes Content",   desc: "Our AI scans for peak engagement moments, detects faces, emotions, laughter, and keywords to find the best clips." },
  { icon: Scissors, color: C.pink,   step: "03", title: "Clips Are Generated",   desc: "Perfectly trimmed shorts are created with smooth cuts, captions burned in, and reframed for vertical screens." },
  { icon: Download, color: C.red,    step: "04", title: "Download & Publish",    desc: "Export your shorts in seconds and publish directly to TikTok, Instagram Reels, or YouTube Shorts." },
];
  ...
  return (
    <section id="how-it-works" aria-label="How it works" className="relative py-24 px-6" style={{ zIndex: 1 }}>
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 80% 50% at 50% 50%, rgba(255,45,120,0.04) 0%, transparent 70%)" }} />

      <div className="text-center mb-16 max-w-2xl mx-auto">
        <span className="inline-block mb-4 text-xs font-semibold uppercase tracking-widest px-3 py-1 rounded-full"
          style={{ background: "rgba(255,214,10,0.1)", color: C.yellow, border: "1px solid rgba(255,214,10,0.3)" }}>
          How It Works
        </span>
        <h2 className="text-4xl md:text-5xl font-black mb-4 leading-tight"
          style={{ color: "#F8F8F8", letterSpacing: "-0.02em" }}>
          From Upload to{" "}
          <span style={{ background: `linear-gradient(135deg,${C.yellow},${C.red})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
            Published
          </span>{" "}
          in Minutes
        </h2>
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="absolute left-6 top-8 bottom-8 w-px hidden md:block"
          style={{ background: `linear-gradient(to bottom, ${C.red}, ${C.yellow}, ${C.pink}, ${C.red})` }} />
